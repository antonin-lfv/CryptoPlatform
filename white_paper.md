...
Crypto Platform is a platform that simulates a complete ecosystem of cryptocurrencies (trading, mining) and NFTs.
...
- Dashboard: Overview of the revenues of each wallet (Crypto, NFT, Mining) and quick navigation.
- Crypto: Two sub-pages to follow the courses and trade.
    - Courses: Cryptocurrency courses, with price evolution over 7 days and the number of open positions.
    - Trading: Interactive chart for trading, with leverage options, stop loss, stop win, etc.
- NFT Marketplace: The NFT market, with a filter system.
- Mining: server inventory, with a filter system.
    - Each server has a detail page with costs and revenues. You can buy, sell or rent servers there.
    - On this detail page, you can also see the revenues and costs in a list of downloadable invoices.
- Quests: List of quests, with rewards in BTC.
- Profile: Distribution of the total wallet, value in USD, and progression in levels and rewards.
- Crypto Wallet: Overview of cryptocurrencies, transactions, wallet evolution, purchase and conversion of
  cryptocurrencies.
- Settings: change of username, notifications, etc.
- FAQ: To explain how the platform works.
